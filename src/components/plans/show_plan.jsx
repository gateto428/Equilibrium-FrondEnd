...
function App() {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-epayco-amount", "80000");
    script.setAttribute("data-epayco-tax", "0.00");
    script.setAttribute("data-epayco-tax-ico", "0.00");
    script.setAttribute("data-epayco-tax-base", "80000");
    script.setAttribute("data-epayco-name", "planes");
    script.setAttribute("data-epayco-description", "Suscripsion equilibrium");
    ...
    return () => {
      document.getElementById("epayco-button-container").removeChild(script);
    };
  }, []);
